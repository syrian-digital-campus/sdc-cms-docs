...
Use any root folder name (example: **`SDC-CMS`**). File names may differ slightly (e.g. **`cms-1.8.4.jar`**).
...
├── cms-1.8.4.jar                         # Spring Boot backend (version may differ)
...
| Item | Description |
|------|-------------|
| **`cms-1.8.4.jar`** | Backend application (version number may differ). |
...
- **`INSTALL_DIR`** — folder containing `cms-1.8.4.jar` (e.g. `C:\sdc-install`).
...
- **Backend:** JAR file name / version (e.g. `cms-1.8.4.jar`).
...
*Document version: 1.8.4 - package examples updated for the 1.8.4 delivery.*
