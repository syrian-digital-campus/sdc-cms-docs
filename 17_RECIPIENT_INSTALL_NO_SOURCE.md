...
Use any root folder name (example: **`SDC-CMS`**). File names may differ slightly (e.g. **`cms-1.6.2.jar`**).
...
├── cms-1.6.2.jar                         # Spring Boot backend (version may differ)
...
| Item | Description |
|------|-------------|
| **`cms-1.6.2.jar`** | Backend application (version number may differ). |
...
- **`INSTALL_DIR`** — folder containing `cms-1.6.2.jar` (e.g. `C:\sdc-install`).
...
- **Backend:** JAR file name / version (e.g. `cms-1.6.2.jar`).
...
*Document version: 1.6.2 - package examples updated for the 1.6.2 delivery.*
